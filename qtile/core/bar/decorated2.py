...
def network(bg: str, fg: str) -> list:
  return [
    modify(
      TextBox,
      **base(bg, fg),
...
def currentscreen(bg: str, fg: str) -> list:
  return [
    # TextBox(
    #   **base(bg, fg),
    #   **iconFont(),
...
widgets = [
  ...
  *network(color['magenta'], color['bg']),
  *currentscreen(color['red'], color['bg']),
